 ...
 * @version 1.0
 */
var TSMT$MatrixFactory = (function () {
    function TSMT$MatrixFactory() {
        // empty
    }
    /**
     ...
     */
    TSMT$MatrixFactory.create = function (rows, cols, initValue) {
        var a = new Array();
    ...
    return TSMT$MatrixFactory;
}());
exports.TSMT$MatrixFactory = TSMT$MatrixFactory;
