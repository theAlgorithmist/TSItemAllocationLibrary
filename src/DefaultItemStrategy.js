...
var TSMT$DefaultItemStrategy = (function () {
    function TSMT$DefaultItemStrategy() {
        // empty
    }
    /**
     ...
     */
    TSMT$DefaultItemStrategy.prototype.transform = function (item, data) {
        // tbd - check on rate computation if capacity is zero or near-zero?  Right now, you break it, you buy it.
        if (item !== null && item instanceof AllocatableItem_1.TSMT$AllocatableItem)
    ...
    return TSMT$DefaultItemStrategy;
}());
exports.TSMT$DefaultItemStrategy = TSMT$DefaultItemStrategy;
